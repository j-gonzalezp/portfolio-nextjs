...
export default function AboutPage() {
  ...
  const dict = translations[locale];
   ...
   const experience: ExperienceItem[] = locale === 'es' ? [ { title: "Profesor de Matemática", place: "I. Agrícola Pascual Baburriza", years: "(2024 - presente)" }, { title: "Profesor de Matemática", place: "Colegio Virtual", years: "(2023)" }, { title: "Docente Profesional", place: "DUOC UC", years: "(2020 - 2023)" }, ] : [ { title: "Mathematics Teacher", place: "I. Agrícola Pascual Baburriza", years: "(2024 - present)" }, { title: "Mathematics Teacher", place: "Colegio Virtual", years: "(2023)" }, { title: "Professional Instructor", place: "DUOC UC", years: "(2020 - 2023)" }, ];
   const education: EducationItem[] = locale === 'es' ? [ { title: "Ciencia de Datos", place: "Talento Digital, Santiago", years: "(Cursando)" }, { title: "Especialización Front-End", place: "Adalid, Santiago", years: "(2025)" }, { title: "Bootcamp Full Stack JavaScript", place: "Talento Digital, Santiago", years: "(2024)" }, { title: "Introducción a la Programación en Python", place: "Talento Digital, Santiago", years: "(2023)" }, { title: "Programación VBA Excel", place: "Teleduc UC, Santiago", years: "(2022)" }, { title: "Pedagogía en Matemática", place: "PUC Chile, Santiago", years: "(2019)" }, ] : [ { title: "Data Science", place: "Talento Digital, Santiago", years: "(Ongoing)" }, { title: "Front-End Specialization", place: "Adalid, Santiago", years: "(2025)" }, { title: "Full Stack JavaScript Bootcamp", place: "Talento Digital, Santiago", years: "(2024)" }, { title: "Introduction to Python Programming", place: "Talento Digital, Santiago", years: "(2023)" }, { title: "Excel VBA Programming", place: "Teleduc UC, Santiago", years: "(2022)" }, { title: "Pedagogy in Mathematics", place: "PUC Chile, Santiago", years: "(2019)" }, ];
